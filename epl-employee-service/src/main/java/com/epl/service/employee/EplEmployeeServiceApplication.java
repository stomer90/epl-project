package com.epl.service.employee;
...
@EnableSwagger2
public class EplEmployeeServiceApplication {

	public static void main(String[] args) {
		SpringApplication.run(EplEmployeeServiceApplication.class, args);
	}
	...
	public Docket swaggerPersonApi10() {
		return new Docket(DocumentationType.SWAGGER_2)
				.select()
					.apis(RequestHandlerSelectors.basePackage("com.epl.service.employee.controller"))
